...
public class Fix {
	...
	public void sup_mix(JFrame frame) {
		...
		btn_book.setFont(new Font("±º∏≤", Font.BOLD, 12));
		...
		btn_best.setFont(new Font("±º∏≤", Font.BOLD, 12));
		...
		btn_find.setFont(new Font("±º∏≤", Font.PLAIN, 10));
		...
		btn_home.setFont(new Font("±º∏≤", Font.BOLD, 12));
		...
		btn_map.setFont(new Font("±º∏≤", Font.BOLD, 12));
